...
#ifndef normal_LMS_NCH
#define normal_LMS_NCH
...
/*class normalLMS_BMD_NC : public LL
...
class normalLMS_BMD_NC : public normalLLModel {
public:
  normalLMS_BMD_NC(Eigen::MatrixXd tY, Eigen::MatrixXd tX, bool SS, bool CV,
                   int junk)
  ...
  normalLMS_BMD_NC(normalLMS_BMD_NC &M) {
