...
#ifndef normal_LOGISTIC_aerts_NCH
#define normal_LOGISTIC_aerts_NCH
...
/*class normalLOGISTIC_aerts_BMD_NC : public LL
...
class normalLOGISTIC_aerts_BMD_NC : public normalLLModel {
public:
  normalLOGISTIC_aerts_BMD_NC(Eigen::MatrixXd tY, Eigen::MatrixXd tX, bool SS,
                              bool CV, int junk)
  ...
  normalLOGISTIC_aerts_BMD_NC(){

  };

  virtual cont_model mean_type() { return cont_model::logistic_aerts; }

  normalLOGISTIC_aerts_BMD_NC(normalLOGISTIC_aerts_BMD_NC &M) {
