...
#ifndef normal_ILOMAX_aerts_NCH
#define normal_ILOMAX_aerts_NCH
...
/*class normalILOMAX_aerts_BMD_NC : public LL
...
class normalILOMAX_aerts_BMD_NC : public normalLLModel {
public:
  normalILOMAX_aerts_BMD_NC(Eigen::MatrixXd tY, Eigen::MatrixXd tX, bool SS,
                            bool CV, int junk)
  ...
  normalILOMAX_aerts_BMD_NC(){

  };

  virtual cont_model mean_type() { return cont_model::invlomax_aerts; }

  normalILOMAX_aerts_BMD_NC(normalILOMAX_aerts_BMD_NC &M) {
