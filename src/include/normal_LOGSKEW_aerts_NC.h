...
#ifndef normal_LOGSKEW_aerts_NCH
#define normal_LOGSKEW_aerts_NCH
...
/*class normalLOGSKEW_aerts_BMD_NC : public LL
...
class normalLOGSKEW_aerts_BMD_NC : public normalLLModel {
public:
  normalLOGSKEW_aerts_BMD_NC(Eigen::MatrixXd tY, Eigen::MatrixXd tX, bool SS,
                             bool CV, int junk)
  ...
  normalLOGSKEW_aerts_BMD_NC(){

  };

  virtual cont_model mean_type() { return cont_model::logskew_aerts; }

  normalLOGSKEW_aerts_BMD_NC(normalLOGSKEW_aerts_BMD_NC &M) {
