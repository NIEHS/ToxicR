...
#ifndef normal_LOMAX_aerts_NCH
#define normal_LOMAX_aerts_NCH
...
/*class normalLOMAX_aerts_BMD_NC : public LL
...
class normalLOMAX_aerts_BMD_NC : public normalLLModel {
public:
  normalLOMAX_aerts_BMD_NC(Eigen::MatrixXd tY, Eigen::MatrixXd tX, bool SS,
                           bool CV, int junk)
  ...
  normalLOMAX_aerts_BMD_NC(){

  };

  virtual cont_model mean_type() { return cont_model::lomax_aerts; }

  normalLOMAX_aerts_BMD_NC(normalLOMAX_aerts_BMD_NC &M) {
