...
public:
  lognormalLLTESTA1(){};
  lognormalLLTESTA1(Eigen::MatrixXd tY, Eigen::MatrixXd tX, bool SS)
...
public:
  lognormalLLTESTA2(){};
  lognormalLLTESTA2(Eigen::MatrixXd tY, Eigen::MatrixXd tX, bool SS)
      : lognormalLL(tY, tX, SS) {
    // if it is a sufficient statistics model
    std::vector<double> vec(tX.data(), tX.data() + tX.rows() * tX.cols());
    std::sort(vec.begin(), vec.end());
...
public:
  lognormalLLTESTR(){};
  lognormalLLTESTR(Eigen::MatrixXd tY, Eigen::MatrixXd tX, bool SS)
      : lognormalLL(tY, tX, SS){
