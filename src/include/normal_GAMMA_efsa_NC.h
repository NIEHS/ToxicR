...
#ifndef normal_GAMMA_efsa_NCH
#define normal_GAMMA_efsa_NCH
...
/*class normalGAMMA_efsa_BMD_NC : public LL
...
class normalGAMMA_efsa_BMD_NC : public normalLLModel {
public:
  normalGAMMA_efsa_BMD_NC(Eigen::MatrixXd tY, Eigen::MatrixXd tX, bool SS,
                          bool CV, int junk)
  ...
  normalGAMMA_efsa_BMD_NC(){

  };

  virtual cont_model mean_type() { return cont_model::gamma_efsa; }

  normalGAMMA_efsa_BMD_NC(normalGAMMA_efsa_BMD_NC &M) {
