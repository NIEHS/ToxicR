...
#ifndef normal_GAMMA_aerts_NCH
#define normal_GAMMA_aerts_NCH
...
/*class normalGAMMA_aerts_BMD_NC : public LL
...
class normalGAMMA_aerts_BMD_NC : public normalLLModel {
public:
  normalGAMMA_aerts_BMD_NC(Eigen::MatrixXd tY, Eigen::MatrixXd tX, bool SS,
                           bool CV, int junk)
  ...
  normalGAMMA_aerts_BMD_NC(){

  };

  virtual cont_model mean_type() { return cont_model::gamma_aerts; }

  normalGAMMA_aerts_BMD_NC(normalGAMMA_aerts_BMD_NC &M) {
