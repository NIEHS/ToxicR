...
#ifndef normal_ILOGSKEW_aerts_NCH
#define normal_ILOGSKEW_aerts_NCH
...
/*class normalILOGSKEW_aerts_BMD_NC : public LL
...
class normalILOGSKEW_aerts_BMD_NC : public normalLLModel {
public:
  normalILOGSKEW_aerts_BMD_NC(Eigen::MatrixXd tY, Eigen::MatrixXd tX, bool SS,
                              bool CV, int junk)
  ...
  normalILOGSKEW_aerts_BMD_NC(){

  };

  virtual cont_model mean_type() { return cont_model::invlogskew_aerts; }

  normalILOGSKEW_aerts_BMD_NC(normalILOGSKEW_aerts_BMD_NC &M) {
