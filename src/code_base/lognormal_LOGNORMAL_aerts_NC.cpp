...
std::vector<double> lognormalLOGNORMAL_aerts_BMD_NC::bmd_start_absolute_clean(
...
std::vector<double> lognormalLOGNORMAL_aerts_BMD_NC::bmd_start_reldev_clean(
    std::vector<double> x, double BMRF, double BMD, bool isIncreasing) {
  double t = 0.0;
...
std::vector<double> lognormalLOGNORMAL_aerts_BMD_NC::bmd_start_stddev_clean(
    std::vector<double> x, double BMRF, double BMD, bool isIncreasing) {
  if (!isIncreasing)
    BMRF *= 1;
...
std::vector<double> lognormalLOGNORMAL_aerts_BMD_NC::bmd_start_point_clean(
    std::vector<double> x, double BMRF, double BMD, bool isIncreasing) {
  double temp = 0;
  temp = gsl_cdf_ugaussian_P(log(x[1] + 1e-9) + x[3] * log(BMD + 1e-9));
...
std::vector<double> lognormalLOGNORMAL_aerts_BMD_NC::bmd_start_extra_clean(
    std::vector<double> x, double BMRF, double BMD, bool isIncreasing) {
...
std::vector<double>
lognormalLOGNORMAL_aerts_BMD_NC::bmd_start_hybrid_extra_clean(
    std::vector<double> x, double BMRF, double BMD, bool isIncreasing,
    double tail_prob) {
...
// Functions: lognormalLOGNORMAL_aerts_BMD_NC::bmd_absolute(Eigen::MatrixXd
// theta, double BMRF, bool isIncreasing)
//			  lognormalLOGNORMAL_aerts_BMD_NC::bmd_stdev(Eigen::MatrixXd
//theta, double BMRF, bool isIncreasing)
//			  lognormalLOGNORMAL_aerts_BMD_NC::bmd_reldev(Eigen::MatrixXd
//theta, double BMRF, bool isIncreasing)
//            lognormalLOGNORMAL_aerts_BMD_NC::bmd_point(Eigen::MatrixXd theta,
...
//            in  lognormalLOGNORMAL_aerts_BMD_NC::bmd_absolute(Eigen::MatrixXd
//            theta, double BMRF, bool isIncreasing)
//
double lognormalLOGNORMAL_aerts_BMD_NC::bmd_absolute_bound(
...
double lognormalLOGNORMAL_aerts_BMD_NC::bmd_stdev_bound(Eigen::MatrixXd theta,
...
double lognormalLOGNORMAL_aerts_BMD_NC::bmd_reldev_bound(Eigen::MatrixXd theta,
                                                         double BMD,
                                                         double BMRF,
                                                         bool isIncreasing) {
  Eigen::MatrixXd d(1, 1);
...
double lognormalLOGNORMAL_aerts_BMD_NC::bmd_extra_bound(Eigen::MatrixXd theta,
                                                        double BMD, double BMRF,
                                                        bool isIncreasing) {
  Eigen::MatrixXd d(1, 1);
  d(0, 0) = 0.0;
...
double lognormalLOGNORMAL_aerts_BMD_NC::bmd_point_bound(Eigen::MatrixXd theta,
                                                        double BMD, double BMRF,
                                                        bool isIncreasing) {
...
////////////////////////////////////////////////////////////////////////
// Function:  double
// lognormalLOGNORMAL_aerts_BMD_NC::bmd_hybrid_extra(Eigen::MatrixXd theta,
...
//
////////////////////////////////////////////////////////////////////////
double lognormalLOGNORMAL_aerts_BMD_NC::bmd_hybrid_extra_bound(
    Eigen::MatrixXd theta, double BMD, double BMRF, bool isIncreasing,
    double TAIL_PROB) {
...
//            theta, double BMRF, bool isIncreasing)
//
double lognormalLOGNORMAL_aerts_BMD_NC::bmd_absolute(Eigen::MatrixXd theta,
                                                     double BMRF,
                                                     bool isIncreasing) {
...
double lognormalLOGNORMAL_aerts_BMD_NC::bmd_stdev(Eigen::MatrixXd theta,
                                                  double BMRF,
                                                  bool isIncreasing) {
  Eigen::MatrixXd d(1, 1);
  d(0, 0) = 0.0;
...
double lognormalLOGNORMAL_aerts_BMD_NC::bmd_reldev(Eigen::MatrixXd theta,
                                                   double BMRF,
                                                   bool isIncreasing) {
  Eigen::MatrixXd d(1, 1);
  d(0, 0) = 0.0;
...
double lognormalLOGNORMAL_aerts_BMD_NC::bmd_point(Eigen::MatrixXd theta,
                                                  double BMRF,
                                                  bool isIncreasing) {
  // note isIncreasing is ignored as point is specified by the user
...
double lognormalLOGNORMAL_aerts_BMD_NC::bmd_extra(Eigen::MatrixXd theta,
                                                  double BMRF,
                                                  bool isIncreasing) {
  Eigen::MatrixXd d(1, 1);
  d(0, 0) = 0.0;
...
//
////////////////////////////////////////////////////////////////////////
double lognormalLOGNORMAL_aerts_BMD_NC::bmd_hybrid_extra(Eigen::MatrixXd theta,
                                                         double BMRF,
                                                         bool isIncreasing,
                                                         double TAIL_PROB) {
...
// double lognormalLOGNORMAL_aerts_BMD_NC::negLogLikelihood(Eigen::MatrixXd
// theta)
// {
