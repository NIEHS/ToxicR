...
*/
double normalPOLYNOMIAL_BMD_NC::bmd_start_absolute(unsigned n, const double *b,
  ...
  double returnV =
      pow(theta(deg + 1, 0) - b[deg + 1], 2.0) + pow(theta(0, 0) - b[0], 2.0);
...
finds the closest point to the supplied value (usually the previous MLE) that
satisfies the equality constraint. Note it always modifies parameters that are
essentially unbounded - in this case it is mu
*/
double normalPOLYNOMIAL_BMD_NC::bmd_start_reldev(unsigned n, const double *b,
                                                 double *grad, void *data) {
  double t;
  start_data *sdata = (start_data *)data;
...
essentially unbounded - nu
*/
double normalPOLYNOMIAL_BMD_NC::bmd_start_stddev(unsigned n, const double *b,
                                                 double *grad, void *data) {
...
essentially unbounded - nu
*/
double normalPOLYNOMIAL_BMD_NC::bmd_start_point(unsigned n, const double *b,
                                                double *grad, void *data) {
...
essentially unbounded - nu
*/
double normalPOLYNOMIAL_BMD_NC::bmd_start_extra(unsigned n, const double *b,
                                                double *grad, void *data) {
...
std::vector<double> normalPOLYNOMIAL_BMD_NC::bmd_start_hybrid_extra_clean(
  ...
  if ((int)x.size() == deg + 3) { // power model
    x[deg + 2] = temp;
  } else {
    x[deg + 1] = temp;
  }
...
// Functions: normalPOLYNOMIAL_BMD_NC::bmd_absolute(Eigen::MatrixXd theta,
// double BMRF, bool isIncreasing)
//			  normalPOLYNOMIAL_BMD_NC::bmd_stdev(Eigen::MatrixXd theta,
//double BMRF, bool isIncreasing)
//			  normalPOLYNOMIAL_BMD_NC::bmd_reldev(Eigen::MatrixXd theta,
//double BMRF, bool isIncreasing)
//            normalPOLYNOMIAL_BMD_NC::bmd_point(Eigen::MatrixXd theta, double
//            BMRF, bool isIncreasing)
// Purpose :  return the BMD given the parameter values theta and the BMRF. Note
// they are  call the code
//            in  normalPOLYNOMIAL_BMD_NC::bmd_absolute(Eigen::MatrixXd theta,
//            double BMRF, bool isIncreasing)
//
double normalPOLYNOMIAL_BMD_NC::bmd_absolute_bound(Eigen::MatrixXd theta,
...
double normalPOLYNOMIAL_BMD_NC::bmd_stdev_bound(Eigen::MatrixXd theta,
                                                double BMD, double BMRF,
                                                bool isIncreasing) {
...
double normalPOLYNOMIAL_BMD_NC::bmd_reldev_bound(Eigen::MatrixXd theta,
                                                 double BMD, double BMRF,
                                                 bool isIncreasing) {
  Eigen::MatrixXd d(2, 1);
  d << 0.0, BMD;
...
double normalPOLYNOMIAL_BMD_NC::bmd_extra_bound(Eigen::MatrixXd theta,
                                                double BMD, double BMRF,
                                                bool isIncreasing) {
  Eigen::MatrixXd d(1, 1);
  d(0, 0) = 0.0;
...
double normalPOLYNOMIAL_BMD_NC::bmd_point_bound(Eigen::MatrixXd theta,
                                                double BMD, double BMRF,
                                                bool isIncreasing) {
...
////////////////////////////////////////////////////////////////////////
// Function:  double normalPOLYNOMIAL_BMD_NC::bmd_hybrid_extra(Eigen::MatrixXd
...
//
////////////////////////////////////////////////////////////////////////
double normalPOLYNOMIAL_BMD_NC::bmd_hybrid_extra_bound(Eigen::MatrixXd theta,
                                                       double BMD, double BMRF,
                                                       bool isIncreasing,
                                                       double TAIL_PROB) {
...
//            double BMRF, bool isIncreasing)
//
double normalPOLYNOMIAL_BMD_NC::bmd_absolute(Eigen::MatrixXd theta, double BMRF,
                                             bool isIncreasing) {
...
double normalPOLYNOMIAL_BMD_NC::bmd_stdev(Eigen::MatrixXd theta, double BMRF,
                                          bool isIncreasing) {
  Eigen::MatrixXd d(1, 1);
  d(0, 0) = 0.0;
  Eigen::MatrixXd temp = variance(theta, d);
...
double normalPOLYNOMIAL_BMD_NC::bmd_reldev(Eigen::MatrixXd theta, double BMRF,
                                           bool isIncreasing) {
  Eigen::MatrixXd d(1, 1);
  d(0, 0) = 0.0;
  Eigen::MatrixXd temp = mean(theta, d);
...
double normalPOLYNOMIAL_BMD_NC::bmd_point(Eigen::MatrixXd theta, double BMRF,
                                          bool isIncreasing) {
  double min = 0.0;
  double mid = 0.0;
  double max = 0.0;
...
double normalPOLYNOMIAL_BMD_NC::bmd_extra(Eigen::MatrixXd theta, double BMRF,
                                          bool isIncreasing) {
  Eigen::MatrixXd d(1, 1);
  d(0, 0) = 0.0;
  Eigen::MatrixXd temp = mean(theta, d);
...
//
////////////////////////////////////////////////////////////////////////
double normalPOLYNOMIAL_BMD_NC::bmd_hybrid_extra(Eigen::MatrixXd theta,
                                                 double BMRF, bool isIncreasing,
                                                 double TAIL_PROB) {
