...
*/
double normalLMS_BMD_NC::bmd_start_absolute(unsigned n, const double *b,
...
std::vector<double>
normalLMS_BMD_NC::bmd_start_absolute_clean(std::vector<double> x, double BMRF,
...
essentially unbounded - c
*/
double normalLMS_BMD_NC::bmd_start_reldev(unsigned n, const double *b,
                                          double *grad, void *data) {
...
std::vector<double>
normalLMS_BMD_NC::bmd_start_reldev_clean(std::vector<double> x, double BMRF,
                                         double BMD, bool isIncreasing) {
  double t = 0.0;
...
*/
double normalLMS_BMD_NC::bmd_start_stddev(unsigned n, const double *b,
                                          double *grad, void *data) {
...
std::vector<double>
normalLMS_BMD_NC::bmd_start_stddev_clean(std::vector<double> x, double BMRF,
                                         double BMD, bool isIncreasing) {
  if (!isIncreasing)
    BMRF *= 1;
...
essentially unbounded - nu
*/
double normalLMS_BMD_NC::bmd_start_point(unsigned n, const double *b,
                                         double *grad, void *data) {
...
std::vector<double>
normalLMS_BMD_NC::bmd_start_point_clean(std::vector<double> x, double BMRF,
                                        double BMD, bool isIncreasing) {
  double temp = 0;
  temp = 1.0 - exp(-x[1] * BMD - x[3] * pow(BMD, 2));
  //	temp = 1.0 - x[1] / (x[1] + pow(BMD, x[3]));
...
essentially unbounded - nu
*/
double normalLMS_BMD_NC::bmd_start_extra(unsigned n, const double *b,
                                         double *grad, void *data) {
...
std::vector<double>
normalLMS_BMD_NC::bmd_start_extra_clean(std::vector<double> x, double BMRF,
                                        double BMD, bool isIncreasing) {
...
essentially unbounded - nu
*/
double normalLMS_BMD_NC::bmd_start_hybrid_extra(unsigned n, const double *b,
                                                double *grad, void *data) {
...
std::vector<double> normalLMS_BMD_NC::bmd_start_hybrid_extra_clean(
...
// Functions: normalLMS_BMD_NC::bmd_absolute(Eigen::MatrixXd theta, double BMRF,
// bool isIncreasing)
//			  normalLMS_BMD_NC::bmd_stdev(Eigen::MatrixXd theta, double
//BMRF, bool isIncreasing) 			  normalLMS_BMD_NC::bmd_reldev(Eigen::MatrixXd theta,
//double BMRF, bool isIncreasing)
//            normalLMS_BMD_NC::bmd_point(Eigen::MatrixXd theta, double BMRF,
//            bool isIncreasing)
// Purpose :  return the BMD given the parameter values theta and the BMRF. Note
// they are  call the code
//            in  normalLMS_BMD_NC::bmd_absolute(Eigen::MatrixXd theta, double
//            BMRF, bool isIncreasing)
//
double normalLMS_BMD_NC::bmd_absolute_bound(Eigen::MatrixXd theta, double BMD,
                                            double BMRF, bool isIncreasing) {
  Eigen::MatrixXd d(2, 1);
  d << 0.0, BMD;
...
double normalLMS_BMD_NC::bmd_stdev_bound(Eigen::MatrixXd theta, double BMD,
                                         double BMRF, bool isIncreasing) {
...
double normalLMS_BMD_NC::bmd_reldev_bound(Eigen::MatrixXd theta, double BMD,
                                          double BMRF, bool isIncreasing) {
  Eigen::MatrixXd d(1, 1);
  d(0, 0) = 0.0;
  Eigen::MatrixXd temp = mean(theta, d);
...
double normalLMS_BMD_NC::bmd_extra_bound(Eigen::MatrixXd theta, double BMD,
                                         double BMRF, bool isIncreasing) {
  Eigen::MatrixXd d(1, 1);
  d(0, 0) = 0.0;
  Eigen::MatrixXd temp = mean(theta, d);
...
double normalLMS_BMD_NC::bmd_point_bound(Eigen::MatrixXd theta, double BMD,
                                         double BMRF, bool isIncreasing) {
...
////////////////////////////////////////////////////////////////////////
// Function:  double normalLMS_BMD_NC::bmd_hybrid_extra(Eigen::MatrixXd theta,
...
//
////////////////////////////////////////////////////////////////////////
double normalLMS_BMD_NC::bmd_hybrid_extra_bound(Eigen::MatrixXd theta,
...
//            BMRF, bool isIncreasing)
//
double normalLMS_BMD_NC::bmd_absolute(Eigen::MatrixXd theta, double BMRF,
                                      bool isIncreasing) {
...
double normalLMS_BMD_NC::bmd_stdev(Eigen::MatrixXd theta, double BMRF,
                                   bool isIncreasing) {
  Eigen::MatrixXd d(1, 1);
  d(0, 0) = 0.0;
  Eigen::MatrixXd temp = variance(theta, d);
...
double normalLMS_BMD_NC::bmd_reldev(Eigen::MatrixXd theta, double BMRF,
                                    bool isIncreasing) {
  Eigen::MatrixXd d(1, 1);
  d(0, 0) = 0.0;
  Eigen::MatrixXd temp = mean(theta, d);
...
double normalLMS_BMD_NC::bmd_point(Eigen::MatrixXd theta, double BMRF,
                                   bool isIncreasing) {
  // note isIncreasing is ignored as point is specified by the user
...
double normalLMS_BMD_NC::bmd_extra(Eigen::MatrixXd theta, double BMRF,
                                   bool isIncreasing) {
  Eigen::MatrixXd d(1, 1);
  d(0, 0) = 0.0;
  Eigen::MatrixXd temp = mean(theta, d);
...
//
////////////////////////////////////////////////////////////////////////
double normalLMS_BMD_NC::bmd_hybrid_extra(Eigen::MatrixXd theta, double BMRF,
