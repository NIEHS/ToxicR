...
*************************************/
double lognormalPOWER_BMD_NC::bmd_start_absolute(unsigned n, const double *b,
...
essentially unbounded - nu
*/
double lognormalPOWER_BMD_NC::bmd_start_reldev(unsigned n, const double *b,
                                               double *grad, void *data) {
...
essentially unbounded - nu
*/
double lognormalPOWER_BMD_NC::bmd_start_stddev(unsigned n, const double *b,
                                               double *grad, void *data) {
...
essentially unbounded - nu
*/
double lognormalPOWER_BMD_NC::bmd_start_point(unsigned n, const double *b,
                                              double *grad, void *data) {
...
std::vector<double>
lognormalPOWER_BMD_NC::bmd_start_point_clean(std::vector<double> x, double BMRF,
...
essentially unbounded - nu
*/
double lognormalPOWER_BMD_NC::bmd_start_extra(unsigned n, const double *b,
                                              double *grad, void *data) {
  return 0.0;
}

std::vector<double>
lognormalPOWER_BMD_NC::bmd_start_extra_clean(std::vector<double> x, double BMRF,
                                             double BMD, bool isIncreasing) {
...
/************************************************************
// Functions: lognormalPOWER_BMD_NC::bmd_absolute(Eigen::MatrixXd theta, double
BMRF, bool isIncreasing)
//			  lognormalPOWER_BMD_NC::bmd_stdev(Eigen::MatrixXd
theta, double BMRF, bool isIncreasing)
//			  lognormalPOWER_BMD_NC::bmd_reldev(Eigen::MatrixXd
theta, double BMRF, bool isIncreasing)
//            lognormalPOWER_BMD_NC::bmd_point(Eigen::MatrixXd theta, double
BMRF, bool isIncreasing)
// Purpose :  return the BMD given the parameter values theta and the BMRF. Note
they are  call the code
//            in  lognormalPOWER_BMD_NC::bmd_absolute(Eigen::MatrixXd theta,
double BMRF, bool isIncreasing)
//
***********************************************************/
double lognormalPOWER_BMD_NC::bmd_absolute_bound(Eigen::MatrixXd theta,
...
double lognormalPOWER_BMD_NC::bmd_stdev_bound(Eigen::MatrixXd theta, double BMD,
                                              double BMRF, bool isIncreasing) {
...
double lognormalPOWER_BMD_NC::bmd_reldev_bound(Eigen::MatrixXd theta,
                                               double BMD, double BMRF,
                                               bool isIncreasing) {
...
double lognormalPOWER_BMD_NC::bmd_extra_bound(Eigen::MatrixXd theta, double BMD,
                                              double BMRF, bool isIncreasing) {
  return 0.0;
}

double lognormalPOWER_BMD_NC::bmd_point_bound(Eigen::MatrixXd theta, double BMD,
                                              double BMRF, bool isIncreasing) {
...
/**
////////////////////////////////////////////////////////////////////////
// Function:  double lognormalPOWER_BMD_NC::bmd_hybrid_extra(Eigen::MatrixXd
...
////////////////////////////////////////////////////////////////////////
*/
double lognormalPOWER_BMD_NC::bmd_hybrid_extra_bound(Eigen::MatrixXd theta,
                                                     double BMD, double BMRF,
                                                     bool isIncreasing,
                                                     double TAIL_PROB) {
...
//
*/
double lognormalPOWER_BMD_NC::bmd_absolute(Eigen::MatrixXd theta, double BMRF,
                                           bool isIncreasing) {
...
double lognormalPOWER_BMD_NC::bmd_stdev(Eigen::MatrixXd theta, double BMRF,
                                        bool isIncreasing) {
  Eigen::MatrixXd d(1, 1);
  d(0, 0) = 0.0;
  Eigen::MatrixXd temp = variance(theta, d);
...
double lognormalPOWER_BMD_NC::bmd_reldev(Eigen::MatrixXd theta, double BMRF,
                                         bool isIncreasing) {
  Eigen::MatrixXd d(1, 1);
  d(0, 0) = 0.0;
  Eigen::MatrixXd temp = mean(theta, d);
...
double lognormalPOWER_BMD_NC::bmd_point(Eigen::MatrixXd theta, double BMRF,
                                        bool isIncreasing) {
  // note isIncreasing is ignored as point is specified by the user
  double gamma = theta(0, 0);
  double beta = theta(1, 0);
...
double lognormalPOWER_BMD_NC::bmd_extra(Eigen::MatrixXd theta, double BMRF,
                                        bool isIncreasing) {
  Eigen::MatrixXd d(1, 1);
  d(0, 0) = 0.0;
  Eigen::MatrixXd temp = mean(theta, d);
...
////////////////////////////////////////////////////////////////////////
*/
double lognormalPOWER_BMD_NC::bmd_hybrid_extra(Eigen::MatrixXd theta,
                                               double BMRF, bool isIncreasing,
                                               double TAIL_PROB) {
