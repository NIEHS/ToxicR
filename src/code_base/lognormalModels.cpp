...
Eigen::MatrixXd lognormalLLModel::starting_value(
    Eigen::MatrixXd theta, contbmd BMDType, double BMD, double BMRF, bool isInc,
    double tail_prob, std::vector<double> lb, std::vector<double> ub) {
  ////////////////////////////////////////////
  double minf;
  nlopt::result result;
  ////////////////////////////////////////////
...
///////////////////
double lognormalLLModel::equality_boundG(Eigen::MatrixXd theta, contbmd BMDType,
...
///////////////////////////////////////////////////////////////////////
Eigen::MatrixXd lognormalLLModel::eqConst_gradient(Eigen::MatrixXd v,
                                                   contbmd type, double BMD,
                                                   double BMRF,
                                                   bool isIncreasing,
                                                   double tail_prob) {
