...
double lognormalLOGSKEW_aerts_BMD_NC::bmd_start_absolute(unsigned n,
  ...
  //	temp = 2.0 * gsl_ran_ugaussian_pdf(temp) *
...
std::vector<double> lognormalLOGSKEW_aerts_BMD_NC::bmd_start_absolute_clean(
...
double lognormalLOGSKEW_aerts_BMD_NC::bmd_start_reldev(unsigned n,
  ...
  temp = gsl_cdf_ugaussian_P(temp) - 2.0 * tfn(temp, xi);
  //	temp = 2.0 * gsl_ran_ugaussian_pdf(temp) *
  //gsl_cdf_ugaussian_P(b[4]*temp); 	temp = (b[2] - 1.0) * temp * (1.0 / t);
  temp = 1.0 + t / temp;
...
std::vector<double> lognormalLOGSKEW_aerts_BMD_NC::bmd_start_reldev_clean(
    std::vector<double> x, double BMRF, double BMD, bool isIncreasing) {
  double t = 0.0;
...
std::vector<double> lognormalLOGSKEW_aerts_BMD_NC::bmd_start_stddev_clean(
    std::vector<double> x, double BMRF, double BMD, bool isIncreasing) {
  if (!isIncreasing)
    BMRF *= 1;
...
std::vector<double> lognormalLOGSKEW_aerts_BMD_NC::bmd_start_point_clean(
    std::vector<double> x, double BMRF, double BMD, bool isIncreasing) {
  double temp = log(x[1]) + x[3] * log(BMD);
  temp = gsl_cdf_ugaussian_P(temp) - 2.0 * tfn(temp, x[4]);
  //	temp = 2.0 * gsl_ran_ugaussian_pdf(temp) *
...
std::vector<double> lognormalLOGSKEW_aerts_BMD_NC::bmd_start_extra_clean(
    std::vector<double> x, double BMRF, double BMD, bool isIncreasing) {
...
std::vector<double> lognormalLOGSKEW_aerts_BMD_NC::bmd_start_hybrid_extra_clean(
    std::vector<double> x, double BMRF, double BMD, bool isIncreasing,
    double tail_prob) {
...
// Functions: lognormalLOGSKEW_aerts_BMD_NC::bmd_absolute(Eigen::MatrixXd theta,
// double BMRF, bool isIncreasing)
//			  lognormalLOGSKEW_aerts_BMD_NC::bmd_stdev(Eigen::MatrixXd
//theta, double BMRF, bool isIncreasing)
//			  lognormalLOGSKEW_aerts_BMD_NC::bmd_reldev(Eigen::MatrixXd
//theta, double BMRF, bool isIncreasing)
//            lognormalLOGSKEW_aerts_BMD_NC::bmd_point(Eigen::MatrixXd theta,
//            double BMRF, bool isIncreasing)
// Purpose :  return the BMD given the parameter values theta and the BMRF. Note
// they are  call the code
//            in  lognormalLOGSKEW_aerts_BMD_NC::bmd_absolute(Eigen::MatrixXd
//            theta, double BMRF, bool isIncreasing)
//
double lognormalLOGSKEW_aerts_BMD_NC::bmd_absolute_bound(Eigen::MatrixXd theta,
                                                         double BMD,
                                                         double BMRF,
                                                         bool isIncreasing) {
  Eigen::MatrixXd d(2, 1);
...
double lognormalLOGSKEW_aerts_BMD_NC::bmd_stdev_bound(Eigen::MatrixXd theta,
...
double lognormalLOGSKEW_aerts_BMD_NC::bmd_reldev_bound(Eigen::MatrixXd theta,
                                                       double BMD, double BMRF,
                                                       bool isIncreasing) {
  Eigen::MatrixXd d(1, 1);
  d(0, 0) = 0.0;
...
double lognormalLOGSKEW_aerts_BMD_NC::bmd_extra_bound(Eigen::MatrixXd theta,
                                                      double BMD, double BMRF,
                                                      bool isIncreasing) {
  Eigen::MatrixXd d(1, 1);
  d(0, 0) = 0.0;
...
double lognormalLOGSKEW_aerts_BMD_NC::bmd_point_bound(Eigen::MatrixXd theta,
                                                      double BMD, double BMRF,
                                                      bool isIncreasing) {
...
////////////////////////////////////////////////////////////////////////
// Function:  double
// lognormalLOGSKEW_aerts_BMD_NC::bmd_hybrid_extra(Eigen::MatrixXd theta, double
...
//
////////////////////////////////////////////////////////////////////////
double lognormalLOGSKEW_aerts_BMD_NC::bmd_hybrid_extra_bound(
...
//            theta, double BMRF, bool isIncreasing)
//
double lognormalLOGSKEW_aerts_BMD_NC::bmd_absolute(Eigen::MatrixXd theta,
                                                   double BMRF,
                                                   bool isIncreasing) {
...
double lognormalLOGSKEW_aerts_BMD_NC::bmd_stdev(Eigen::MatrixXd theta,
                                                double BMRF,
                                                bool isIncreasing) {
  Eigen::MatrixXd d(1, 1);
  d(0, 0) = 0.0;
...
double lognormalLOGSKEW_aerts_BMD_NC::bmd_reldev(Eigen::MatrixXd theta,
                                                 double BMRF,
                                                 bool isIncreasing) {
...
double lognormalLOGSKEW_aerts_BMD_NC::bmd_point(Eigen::MatrixXd theta,
                                                double BMRF,
                                                bool isIncreasing) {
  // note isIncreasing is ignored as point is specified by the user
...
double lognormalLOGSKEW_aerts_BMD_NC::bmd_extra(Eigen::MatrixXd theta,
                                                double BMRF,
                                                bool isIncreasing) {
  Eigen::MatrixXd d(1, 1);
  d(0, 0) = 0.0;
...
//
////////////////////////////////////////////////////////////////////////
double lognormalLOGSKEW_aerts_BMD_NC::bmd_hybrid_extra(Eigen::MatrixXd theta,
                                                       double BMRF,
                                                       bool isIncreasing,
                                                       double TAIL_PROB) {
