 ...
 * $ National Toxicology Program (NIEHS) Copyright 2020  US HHS, NIEHS
 */
...
static double COF[] = {76.18009173e0,  -86.50532033e0, 24.01409822e0,
                       -1.231739516e0, 0.120858003e-2, -.536382e-5};
...
class TDMSE_PolyK {
public:
  double polyk_mod(PolyKPrepareClass subsetVars, int ntrt, int polyKTestType,
