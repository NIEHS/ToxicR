...
test_that("Hill Laplace", {
     ...
     validate_model2(
          c, "Model:  Hill", c(-1.673544, 3.459392, 5.833098, 1.462155),
...
test_that("Weibull Laplace", {
     ...
     validate_model2(
          c, "Model: Weibull", c(-1.7686897, 0.7951624, 14.4332211),
...
test_that("Weibull MLE", {
     ...
     validate_model2(
          c, "Model: Weibull", c(-1.8014517, 0.7668152, 13.6038641),
...
test_that("Gamma MLE", {
     ...
     validate_model2(
          c, "Model:  Gamma", c(-1.671756, 1.000000, 24.832283),
...
test_that("Gamma MLE", {
     ...
     validate_model2(
          c, "Model:  Gamma", c(-1.7531361, 0.7512065, 18.8926902),
