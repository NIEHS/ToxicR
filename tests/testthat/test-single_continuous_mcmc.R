...
#
# 6/5/22 Removed the Ewald options
#        as it made no sense with MCMC
#        Also, dropped Hill as it is not a test case because the likelihood is ill-defined.
#        with this data.
